# PRIVACY POLICY APIK KIP

_Updated on January the 02nd 2022_

This Privacy Policy is addressed to you, as a user of the KIP application (hereinafter the "Application"). It is written to describe and inform you of the processing that may be performed. 
...
* **KIP identification data**: this includes your contact information required to create your online customer account, including your first name(s), last name(s), email address, telephone number, user ID and password.  
...
* **KIP location data**: this includes your geolocation data. 
